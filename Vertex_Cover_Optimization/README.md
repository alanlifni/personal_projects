...
To help the police department minimize their installation of security cameras at traffic intersections
...
* mod is used to change the specification of a street. Its format is the same as for a. It is a new specification for a street you’ve specified before.
* rm is used to remove a street. It is specified as “r "Street Name"”. 
...
* issue enough rm commands to clear any existing street database
* issue add commands to add new streets satisfying the specification
* issue a gg command
